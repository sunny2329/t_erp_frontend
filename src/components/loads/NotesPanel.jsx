...
// Chat/timeline-style notes log — the list+composer half of what used to be
// NotesModal, pulled out so it can render inline as its own section in
// LoadEditDrawer instead of behind a click-to-open modal. NotesModal still
// wraps this in a <Modal> for anywhere that still wants the popup form.
export function NotesPanel({ loadId }) {
